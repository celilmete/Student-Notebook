...
public class EditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set theme
        SharedPreferences sharedPreferences = getSharedPreferences(NoteActivity.APP_PREFERENCES, Context.MODE_PRIVATE);
        int theme = sharedPreferences.getInt(NoteActivity.THEME_Key, R.style.AppTheme);
        setTheme(theme);
...
//        setSupportActionBar(toolbar);
    ...
    public void saveResponseNote(String text){
        if (!text.isEmpty()) {
            long date = new Date().getTime(); // get  system time
            // if  exist update els crete new
            if (temp == null) {
